...
module.exports = function(__global_opts) {
  ...
  var sift_object = { event: {}, fingerprint: {}, CONSTANTS: constants, __global_opts: __global_opts };
    ...
    // Use the default promise callback
      ...
      var callback = function(_err, _response) {
        ...
        // Not sure
          ...
          return deferred.reject({ message: 'An unexpected error has occured.', response: _response.body });
      };
  ...
  var sift_events = [ 'create_order', 'transaction', 'create_account', 'update_account', 'add_item_to_cart', 'remove_item_from_cart', 'submit_review', 'send_message', 'login', 'logout', 'link_session_to_user' ];
  ...
  // @return promise || void
  //
  sift_object.fingerprint.getSession = function(_session_id, _callback) {
    var opts = {
      method: 'GET',
  ...
  // @return promise || void
  //
  sift_object.fingerprint.getDevice = function(_device_fingerprint, _callback) {
    var opts = {
      method: 'GET',
  ...
  // @return promise || void
  //
  sift_object.fingerprint.labelDevice = function(_device_fingerprint, _label, _callback) {
  ...
  // @return promise || void
  //
  sift_object.fingerprint.getDevices = function(_user_id, _callback) {
    var opts = {
      method: 'GET',
