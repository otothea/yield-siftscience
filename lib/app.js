...
module.exports = function(__global_opts) {
  ...
  if (typeof(__global_opts) !== 'object') {
    ...
    err.message = 'Argument must be an object. If you have recently updated from <= 0.0.9 to >= 0.1.0, you likely need to change the way you require the package. https://github.com/otothea/yield-siftscience#usage';
    throw err;
  }
  ...
  __global_opts.webhooks = typeof(__global_opts.webhooks) === 'object' ? __global_opts.webhooks : {};
