...
module.exports = function(__global_opts) {
  ...
  if (typeof(__global_opts) !== 'object') {
    ...
    err.message = 'Argument must be an object. If you have recently updated from <= 0.0.8 to >= 0.0.9, you likely need to change the way you require the package. https://github.com/otothea/yield-siftscience#usage';
    throw err;
  }
