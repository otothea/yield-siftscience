...
module.exports = function(__global_opts) {
  ...
  if (typeof(__global_opts) !== 'object') {
    ...
    err.message = 'Init argument must be an object. If you have recently updated from <= 0.0.8 to >= 0.0.9 you likely need to change the way you init the siftscience object. https://github.com/otothea/yield-siftscience#usage';
    throw err;
  }
  ...
  var sift_object = { event: {}, fingerprint: {}, partner: {}, CONSTANTS: constants, __global_opts: __global_opts };
